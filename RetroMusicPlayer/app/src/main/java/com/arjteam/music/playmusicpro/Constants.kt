...
object Constants {
    const val PRO_VERSION_PRODUCT_ID = "arjteam_sync_music_purchase"
    const val RATE_ON_GOOGLE_PLAY =
//      "https://play.google.com/store/apps/details?id=com.arjteam.music.playmusic"
      "http://apps.samsung.com/appquery/appDetail.as?appId=com.arjteam.music.playmusicpro"
    const val TRANSLATE = "https://github.com/h4h13/RetroMusicPlayer"
    const val GITHUB_PROJECT = "https://github.com/Rinshul05/MusicPlayer"
